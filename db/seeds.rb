...
Post.create!(content: "누군가 제대하면 남겨놓은 이 책을 관물대 위에서 발견했다. 이 책 이후로 내게도 교양이란게 조금씩 생겼나봐. 독재자를 찬양하고 중2병 공주마냥 허세가 심한 건 용서가 되지만 위안부에 대해 함부로 주둥아리를 놀렸다는 사실에 당신의 공감능력을 의심했다. #내가_사랑한_간결한_문체 #시오노나나미 #책좀읽자 #저자가_중2병 #위안부망언",
             user_id: 1,
             book_id: 2)
...
Post.create!(content: "이미 다른 서평들을 비롯한 이 책에 쏟아진 찬사들을 읽어보았다면 이 책이 어떤 책인지, 지갑에서 돈을 지불할 가치가 있는지 파악이 끝났을 것이라 여겨진다. 형님의 베스트셀러 중 하나! #박재호 #이해영 #jrogue_외에_번역불가 #아직도_구입안했니",
             user_id: 1,
             book_id: 6)
...
Post.create!(content: "작가 자신은 당시에 hclc에 포스팅했던, 의욕이 넘치던 시절의 불필요하고 까다로운 논쟁들을 부끄럽다고 치부하지만, '어설프게 아는 것은 아예 모르는 것보다 위험하다'며 공격하는 작가와 이에 발끈해서 달겨들던, 입만 살아있는 전문가들의 키배를 지켜보는 일은 흥미진진하고 재미있었다.  #전웅 #C #프로그래밍 #C99 #hclc #그립다_hclc",
             user_id: 1,
             book_id: 9)
