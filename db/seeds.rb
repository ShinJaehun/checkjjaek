...
Post.create!(content: "매일 조금씩 책을 덮을 때의 느낌을 감히 새벽 초소에서 근무를 끝내고 돌아온 신병이 관물대에 숨겨놓은 건빵을 몇 개 집어 먹고 남은 건빵 봉지를 보며 느끼는 흐뭇함에 비교하고 싶다. #Mac개발기 #악마잡스 #애플",
             user_id: 1,
             book_id: 8)
...
Post.create!(content: "입만 살아있는 전문가들을 압도하는 컴퓨터 과학 지식의 경전 #전웅 #C #프로그래밍 #C99 #hclc #그립다_hclc",
             user_id: 1,
             book_id: 9)
